...
const messages = {
  en: {
    ...
    exportFullBackupDescription:
      'Tasks, Focus Modes, settings, statistics, theme, and safe timer state as a JSON file.',
    ...
    focusModes: 'Focus Modes',
    focusModeDefault: 'Default / Manual',
    focusModeNext: 'Next Work: {mode}',
    focusModeCurrentCycle: 'Current cycle: {mode}',
    focusModeTaskOverride: 'Task mode',
    focusModeApply: 'Apply',
    focusModeManage: 'Manage modes',
    focusModeSaveCurrent: 'Save current setup',
    focusModeCreate: 'New custom mode',
    focusModeEdit: 'Edit custom mode',
    focusModeDeleteConfirm: 'Delete this Focus Mode? Task bindings will return to Default / Manual.',
    focusModeBuiltIn: 'Built-in',
    focusModeCustom: 'Custom',
    focusModeDeleted: 'Deleted mode',
    focusModeTitle: 'Title',
    focusModeTitlePlaceholder: 'My focus mode',
    focusModeSound: 'Focus sound',
    focusModeSoundNone: 'None',
    focusModeAutoStart: 'Auto-start breaks',
    focusModeDuplicateError: 'A Focus Mode with this title already exists.',
    focusModeBuiltInError: 'Built-in Focus Modes cannot be changed.',
    focusModeGenericError: 'Could not save Focus Mode changes.',
    focusModeTaskBinding: 'Focus Mode',
    focusModeNoBinding: 'No binding',
  ...
  ru: {
    ...
    exportFullBackupDescription:
      'Задачи, режимы фокуса, настройки, статистика, тема и безопасное состояние таймера в JSON-файле.',
    ...
    focusModes: 'Режимы фокуса',
    focusModeDefault: 'По умолчанию / Вручную',
    focusModeNext: 'Следующая работа: {mode}',
    focusModeCurrentCycle: 'Текущий цикл: {mode}',
    focusModeTaskOverride: 'Режим задачи',
    focusModeApply: 'Применить',
    focusModeManage: 'Управление режимами',
    focusModeSaveCurrent: 'Сохранить текущие настройки',
    focusModeCreate: 'Новый режим',
    focusModeEdit: 'Изменить режим',
    focusModeDeleteConfirm: 'Удалить этот режим фокуса? Привязанные задачи вернутся к настройкам по умолчанию.',
    focusModeBuiltIn: 'Встроенный',
    focusModeCustom: 'Пользовательский',
    focusModeDeleted: 'Удалённый режим',
    focusModeTitle: 'Название',
    focusModeTitlePlaceholder: 'Мой режим фокуса',
    focusModeSound: 'Фоновый звук',
    focusModeSoundNone: 'Без звука',
    focusModeAutoStart: 'Автозапуск перерывов',
    focusModeDuplicateError: 'Режим фокуса с таким названием уже существует.',
    focusModeBuiltInError: 'Встроенные режимы нельзя изменять.',
    focusModeGenericError: 'Не удалось сохранить изменения режима.',
    focusModeTaskBinding: 'Режим фокуса',
    focusModeNoBinding: 'Без привязки',
